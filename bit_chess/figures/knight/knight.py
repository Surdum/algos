...
@_64_bits_result
def calculate_knight_step_mask(knight_position):
    if knight_position > 63:
        raise Exception('King position have to be in range [0..63]')

    knight_mask = 1 << knight_position

    without_a = knight_mask & 0xfefefefefefefefe
    without_b = knight_mask & 0xfdfdfdfdfdfdfdfd
    without_ab = without_a & without_b

    without_g = knight_mask & 0xbfbfbfbfbfbfbfbf
    without_h = knight_mask & 0x7f7f7f7f7f7f7f7f
